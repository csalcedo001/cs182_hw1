...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        scores, cache_h1 = affine_forward(X, self.params['W1'], self.params['b1'])
        scores, cache_relu1 = relu_forward(scores)
        scores, cache_h2 = affine_forward(scores, self.params['W2'], self.params['b2'])
        ...
        grads = relu_backward(grads, cache_relu2)
        grads = affine_backward(grads, cache_h2)
        grads = relu_backward(grads, cache_relu1)
        grads = affine_backward(grads, cache_h1)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
